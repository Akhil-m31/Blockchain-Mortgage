...
export const CONTRACT_ADDRESS = (import.meta.env.VITE_CONTRACT_ADDRESS || "").replace(/['"]/g,"").trim();
if (!CONTRACT_ADDRESS || CONTRACT_ADDRESS === "0x...") console.warn("VITE_CONTRACT_ADDRESS is not correctly defined in .env");
